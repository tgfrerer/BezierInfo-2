(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["BezierSectionHandlers"] = factory();
	else
		root["BezierSectionHandlers"] = factory();
})(this, function() {
...
window["Bezier Section Handlers"] = {
  ...
  "pointvectors3d": {
    handler: function () {
      ...
      return {
        ...
        getVectors: function getVectors(d1curve, t) {
          ...
          R = [r.x * r.x, r.x * r.y - r.z, r.x * r.z + r.y, r.x * r.y + r.z, r.y * r.y, r.y * r.z - r.x, r.x * r.z - r.y, r.y * r.z + r.x, r.z * r.z];
          n = {
          ...
          return { dt: dt, a: a, ddt: ddt, r: r, R: R, n: n };
        },

        drawVector: function drawVector(api, from, to, len, r, g, b, project) {
          var prj = function prj(p) {
            return api.project(p, vectorOffset);
          };
          to = normalize(to);
        ...
        drawVectors: function drawVectors(api) {
          api.reset();
          var prj = function prj(p) {
            return api.project(p, vectorOffset);
          };
        ...
        setupNormals: function setupNormals(api) {
          normalsOffset = {
            x: 2 * api.getPanelWidth() / 5,
            y: 4 * api.getPanelHeight() / 5
          };
        ...
        drawNormals: function drawNormals(api) {
          api.reset();
          var prj = function prj(p) {
            return api.project(p, vectorOffset);
          };
  ...
  "bsplines": {
    handler: function () {
      return {
        basicSketch: __webpack_require__(1),
        interpolationGraph: __webpack_require__(3),
        uniformBSpline: __webpack_require__(6),
        centerCutBSpline: __webpack_require__(2),
        openUniformBSpline: __webpack_require__(4),
        rationalUniformBSpline: __webpack_require__(5),
